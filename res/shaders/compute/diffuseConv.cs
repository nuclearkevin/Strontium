 ...
 * Many thanks to http://alinloghin.com/articles/compute_ibl.html, much of the
...
layout(rgba16f, binding = 0) uniform readonly imageCube environmentMap;
...
void main()
{
  //vec2 cubemapSize = vec2(512.0, 512.0);
