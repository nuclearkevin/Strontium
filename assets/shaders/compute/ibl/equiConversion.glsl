...
// Function for converting from 2D texture coordinates to 2D image coordinates.
ivec2 texToImage2D(vec2 texCoord, vec2 imageSize);
// Function for sampling a spherical map.
